...
export const sendFormButton = document.querySelector('.send-form-button');
export const inputName = document.querySelector('#user-name');
export const inputHeight = document.querySelector('#user-height');
export const inputWeight = document.querySelector('#user-weight');
const spanName = document.querySelector('.bmi-info-container h2 span');
const h2Result = document.querySelector('.header-result-container h2');
const spanBMIResult = document.querySelector('.header-result-container h3 span');
const pTips = document.querySelector('.tips-content p');
...
// TODO: Verificar onde colocar essa função;
function addInputEventListener(inputs) {
...
export function displayBMIInfo() {
    ...
    const { BMIIsUnderWeight, BMIIsNormalWeight, BMIIsOverWeight, BMIIsObesityClassOne, BMIIsObesityClassTwo, BMIIsObesityClassThree, } = BMIClassifications;
